...
Research on open-source, multilingual open-source TTS models with Khmer support (see `README.md` and `docs/`; the deliverable `.docx`/`.pdf` are in `reports/`, generated by `docs/build/` — never hand-edited). The practical output of the research is a 4-way model comparison:
